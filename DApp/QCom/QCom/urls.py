...
urlpatterns = [
    ...
    path('alltxns/', views.displayAllTransactions, name='displayAllTransactions'),
    path('savetransaction/', views.saveTransaction, name='saveTransaction'),
    path('getunvtxns/', views.getUnverifiedTransactions, name='getUnverifiedTransactions'),
    path('updatevrftxns/', views.updateVerifiedTransactions, name='updateVerifiedTransactions'),
    path('callqf/', views.callQuickFunction, name='callQuickFunction'),
